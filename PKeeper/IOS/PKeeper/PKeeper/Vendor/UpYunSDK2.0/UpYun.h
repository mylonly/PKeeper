...
#define DEFAULT_BUCKET @"pk-image"

/**
 *	@brief	默认表单API功能密钥 （必填项），可在init之后修改passcode的值来更改
 */
#define DEFAULT_PASSCODE @"MCcyrZzZmdWrtReO/tm5jH2/Rbs="
//#define DEFAULT_PASSCODE @"kdc/DDjp6UwDs6zam5dYrVS73oM="
/**
...
typedef void(^PROGRESS_BLOCK)(CGFloat percent,long long requestDidSendBytes,long long totalBytes);
