...
@protocol PPiFlatSegmentedControlDelegate <NSObject>
@optional
- (BOOL)willSelectAtIndex:(NSUInteger)index;
...
@property (nonatomic, strong) id<PPiFlatSegmentedControlDelegate> delegate;
